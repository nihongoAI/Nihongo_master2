...
import { ChevronLeft, ChevronRight, Repeat, CheckCircle2, XCircle, BookOpen } from 'lucide-react';
    ...
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      <div className="bg-white rounded-lg shadow-sm p-6">
        ...
        <div className="flex items-center justify-center min-h-[300px] mb-6">
          {studyMode === 'flashcard' ? (
            <div
              className={`w-full max-w-md aspect-[3/2] perspective-1000 ${isFlipped ? 'rotate-y-180' : ''}`}
              onClick={() => setIsFlipped(!isFlipped)}
            >
              <div className="relative w-full h-full transition-transform duration-300 transform-style-preserve-3d cursor-pointer">
